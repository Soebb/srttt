...
async def hardmux(client, message):
    ...
    #os.system(f"ffmpeg -i {Config.DOWNLOAD_DIR}/1{final_filename} -filter:v scale=-2:720:force_original_aspect_ratio=increase {Config.DOWNLOAD_DIR}/{final_filename}")
